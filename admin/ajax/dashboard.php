<?php
    ...
    if(isset($_POST['booking_analytics']))
    {
        ...
        $result = mysqli_fetch_assoc(mysqli_query($con,"SELECT
            ...
            COUNT(CASE WHEN booking_status='cancelled' AND (refund=1 OR refund=0) THEN 1 END) AS `cancelled_bookings`,
            SUM(CASE WHEN booking_status='cancelled' AND (refund=1 OR refund=0) THEN `trans_amt` END) AS `cancelled_amt`
