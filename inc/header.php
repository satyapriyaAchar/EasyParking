...
<!-- <nav class="navi">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light px-lg-3 py-lg-2 shadow-sm sticky-top">
      <div class="container-fluid">
          <a class="navbar-brand me-5 fw-bold fs-3" href="#">EasyParking</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                      <a class="nav-link me-2" href="index.php#services">Services</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link me-2" href="index.php#question">FAQ</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link me-2" href="index.php#contact">Contact</a>
                  </li>
              </ul>
              <div class="d-flex">
